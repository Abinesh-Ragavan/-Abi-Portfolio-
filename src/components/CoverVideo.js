  ...
  return (
    <VideoContainer>
        ...
        <Title variants={container} initial="hidden" animate="show">
            ...
            <div>
            <motion.h2  variants={item} data-scroll data-scroll-delay='0.20' data-scroll-speed='2'>Inspire</motion.h2>
             <motion.h2  variants={item} data-scroll data-scroll-delay='0.16' data-scroll-speed='2'>. Create</motion.h2>
              <motion.h2  variants={item} data-scroll data-scroll-delay='0.13' data-scroll-speed='2'>. Belive</motion.h2>
</div>
        </Title>
